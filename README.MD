...
* The "foundOnRemote" flag is set to `false` when a conflicting JAR was found online for a user-selected UID, even though the tool affirms the opposite to the user
